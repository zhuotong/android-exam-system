 ...
 */
package com.msxt.booking.booking;
...
import com.msxt.booking.model.Booking;
import com.msxt.booking.model.Booking_;
...
public class BookingHistory {
    ...
    private void fetchBookingsForCurrentUser() {
        String username = currentUserInstance.get().getName();
        ...
        cquery.select(booking).where(builder.equal(booking.get(Booking_.user).get(User_.name), username))
