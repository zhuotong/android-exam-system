 ...
 */
package com.msxt.booking.account;
...
public class Registrar {
    ...
    private boolean verifyUsernameIsAvailable() {
        User existing = em.find(User.class, newUser.getName());
        if (existing != null) {
            messages.warn(new BundleKey("messages", "account_usernameTaken"))
                    ...
                    .targets(usernameInput.getClientId()).params(newUser.getName());
            return false;
        }
